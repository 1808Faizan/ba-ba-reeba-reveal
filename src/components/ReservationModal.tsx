                  ...
                  >
                    ...
                    <div className="mb-6">
                      ...
                      <select
                        ...
                        className="w-full p-4 bg-white/20 border-none rounded-sm text-white placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-white/30"
                      >
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div>
                        ...
                        <select
                          ...
                          className="w-full p-4 bg-white/20 border-none rounded-sm text-white focus:outline-none focus:ring-2 focus:ring-white/30"
                        >
                    ...
                    <button
                      ...
                      className="flex items-center justify-center gap-2 mx-auto text-lg font-medium text-white/70 hover:text-white transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                    >
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div className="p-4 bg-white/20 rounded-sm">
                        <span className="text-sm text-white/60 block mb-1">Guests</span>
                        <span>{formData.guests}</span>
                      </div>
                      <div className="p-4 bg-white/20 rounded-sm">
                        <span className="text-sm text-white/60 block mb-1">Date</span>
                    ...
                    <div className="mb-6">
                      <label className="flex items-start gap-3 cursor-pointer">
                        ...
                        <div>
                          ...
                          <span className="text-white/70 ml-2 text-sm">Click here for additional details</span>
                        </div>
                      </label>
                      {formData.termsAccepted && (
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 text-lg font-medium text-white/70 hover:text-white transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                      >
                        Continue <ArrowRight size={20} />
                      </button>
                    </div>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full p-3 bg-white/20 border-none rounded-sm text-white focus:outline-none focus:ring-2 focus:ring-white/30"
                        />
                      </div>
                      <div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                      <div>
                        ...
                        <select
                          ...
                          className="w-full p-3 bg-white/20 border-none rounded-sm text-white focus:outline-none focus:ring-2 focus:ring-white/30"
                        >
                          <option value="" className="text-[#1a1a1a]">Select Age Range</option>
                          {ageRanges.map((age) => (
                            <option key={age} value={age} className="text-[#1a1a1a]">{age}</option>
                          ))}
                        </select>
                      </div>
                      <div>
                    ...
                    <div className="mb-6">
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full p-3 bg-white/20 border-none rounded-sm text-white focus:outline-none focus:ring-2 focus:ring-white/30 resize-none"
                      />
